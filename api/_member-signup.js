        ...
        <div style="font-family:Georgia,serif;max-width:540px;margin:0 auto;color:#0D0D0D;background:#FAFAF8;">
          ...
          <div style="padding:2.5rem 2rem;">
            ...
            <div style="text-align:center;margin:2rem 0;">
              <a href="https://zolanailstudio.com/client-portal.html" style="background:#C4A882;color:#0D0D0D;padding:0.875rem 2rem;text-decoration:none;font-size:0.78rem;letter-spacing:0.15em;text-transform:uppercase;font-weight:700;font-family:Georgia,serif;">Go to My Portal</a>
            </div>
            <p style="color:#8B6A3E;font-size:0.82rem;border-top:1px solid rgba(196,168,130,0.2);padding-top:1.25rem;margin-top:2rem;">Zola Nail Studio &middot; Porterville, CA &middot; <a href="https://zolanailstudio.com" style="color:#C4A882;">zolanailstudio.com</a></p>
          </div>
        </div>
      `,
    });
